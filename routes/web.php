...
Route::group(['middleware' => 'auth:web-admin'], function() {
    ...
    Route::group(['middleware' => 'admin_is_master'], function() {
        ...
        Route::get('admin-master', 'AdminMasterController@index')->name('admin-master');
        Route::get('admin-master/create', 'AdminMasterController@create')->name('admin-master.create');
        Route::post('admin-master/store', 'AdminMasterController@storeWeb')->name('admin-master.store');
        Route::post('admin-master/{id}/update', 'AdminMasterController@updateWeb')->name('admin-master.update');
        Route::get('admin-master/{id}/edit', 'AdminMasterController@edit')->name('admin-master.edit');
        Route::get('admin-master/{id}/delete', 'AdminMasterController@destroy')->name('admin-master.delete');
